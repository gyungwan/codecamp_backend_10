...
function solution(id_list, report, k) {
  ...
  const reportList = {}; //신고당한 사람의 누적 신고량 저장

  const answer = [];
  report = [...new Set(report)]; //Array.form(new Set(report))
...
function solution(id_list, report, k) {
  ...
  report.forEach((el) => {
    ...
    if (reportList[el[1]] === undefined) reportList[el[1]] = 0;
